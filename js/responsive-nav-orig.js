...
// https://trentwalton.com/2013/01/16/windows-phone-8-viewport-fix/
...
window.matchMedia = window.matchMedia || function(a) {
    ...
    b.appendChild(e);
    return function(a) {
        e.innerHTML = '&shy;<style media="' + a + '"> #mq-test-1 { width: 42px; }</style>';
        c.insertBefore(b, g);
        d = 42 === e.offsetWidth;
        c.removeChild(b);
        return {
...
(function(a) {
    a.picturefill = function() {
        for (var d = a.document.getElementsByTagName("div"), c = 0, g = d.length; c < g; c++)
            if (null !== d[c].getAttribute("data-picture")) {
                for (var b = d[c].getElementsByTagName("div"), e = [], f = 0, j = b.length; f < j; f++) {
                    var h = b[f].getAttribute("data-media");
                    (!h || a.matchMedia && a.matchMedia(h).matches) && e.push(b[f])
                }
                b = d[c].getElementsByTagName("img")[0];
                e.length ? (b || (b = a.document.createElement("img"), b.alt = d[c].getAttribute("data-alt"), d[c].appendChild(b)), b.src = e.pop().getAttribute("data-src")) :
                    b && d[c].removeChild(b)
            }
    };
